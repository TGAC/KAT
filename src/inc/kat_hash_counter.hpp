...
protected:
  shared_ptr<array>       ary_;
  shared_ptr<array>       new_ary_;
...
public:
  kat_hash_counter(size_t size, // Size of hash. To be rounded up to a power of 2
  ...
  shared_ptr<array> ary() { return ary_; }
  const shared_ptr<array> ary() const { return ary_; }
