...
namespace kat {
    ...
    public:
        ...
        Comp(path _input1, path _input2) : Comp(_input1, _input2, path()) {}
        
        Comp(path _input1, path _input2, path _input3) : input1(_input1), input2(_input2), input3(_input3) {}
    ...
    public:
        ...
        static int main(int argc, char *argv[]) {
            ...
            generic_options.add_options()
                    ...
                    ("canonical1,c2", po::bool_switch(&canonical_2)->default_value(false),
