...
#define sect_args_HELP "Estimates coverage for sequences in a fasta file using jellyfish kmer counts. " \
  ...
  " -x, --gc_bins        Number of bins for the gc data when creating the contamination matrix (1001).\n" \
  " -y, --cvg_bins       Number of bins for the cvg data when creating the contamination matrix (1001).\n" \
